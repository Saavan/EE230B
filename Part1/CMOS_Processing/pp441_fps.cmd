...
diffuse laser temp= $LASER_AMBIENT_TEMP_degC time= $LASER_DURATION_ms<ms> info= 1 write.temp.file= n441_LATemp

 
SetPlxList { BTotal AsTotal }
WritePlx n441_anneal.plx y= [expr $Ymid-($Lg/2.0-0.01)]
